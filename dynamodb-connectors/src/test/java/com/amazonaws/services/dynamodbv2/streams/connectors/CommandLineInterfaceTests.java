...
public class CommandLineInterfaceTests {
    private final String pipelineValue = "masterToReplica";
    ...
    private final String sourceEndpointValue = "preview-dynamodb.eu-west-1.amazonaws.com";
    private final String sourceTableValue = "SingleShardMax2";

    private final String[] sampleArgs = {CommandLineArgs.PIPELINE, pipelineValue, CommandLineArgs.DESTINATION_ENDPOINT,
    ...
    public void missingOptionTest() {
        ...
        incompleteArgs.remove(CommandLineArgs.PIPELINE);
        incompleteArgs.remove(pipelineValue);
    ...
    public void completeArgsTest() {
        ...
        assertEquals(args.getPipeline(), pipelineValue);
