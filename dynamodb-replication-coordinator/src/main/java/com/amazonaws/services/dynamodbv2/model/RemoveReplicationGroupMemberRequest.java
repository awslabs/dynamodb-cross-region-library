...
/**
 * Request for the RemoveReplicationGroupMember operation.
 */
@Data
public class RemoveReplicationGroupMemberRequest {
     ...
     */
    public RemoveReplicationGroupMemberRequest withMemberArn(String memberArn) {
     ...
     * @return A reference to this instance for chained calls
     */
    public RemoveReplicationGroupMemberRequest withReplicationGroupUUID(String replicationGroupUUID) {
